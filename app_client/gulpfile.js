...
var paths = {
    scripts: 'ui_code/**/*.js',
    styles: ['./ui_code/**/*.css', './ui_code/**/*.scss'],
    images: './ui_code/images/**/*',
    fonts: './ui_code/styles/fonts/**/*',
    locales: './ui_code/i18n/**/*.json',
    index: './ui_code/index.html',
    partials: ['ui_code/**/*.html', '!ui_code/index.html'],
    distDev: './dist.dev',
    distProd: './dist.prod',
